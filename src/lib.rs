...
/**
 Retorna todos arquivos XML configurados 
 para a transição de wallpapers, serão 
 na verdade retornados seus caminhos. Eles
 estão em diretórios próprios junto com
 suas imagens.
*/
